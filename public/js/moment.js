;(function (global, factory) {
    ...
    var cs__months = 'leden_únor_b?ezen_duben_kv?ten_?erven_?ervenec_srpen_zá?í_?íjen_listopad_prosinec'.split('_'),
        cs__monthsShort = 'led_úno_b?e_dub_kv?_?vn_?vc_srp_zá?_?íj_lis_pro'.split('_');
    ...
    function cs__translate(number, withoutSuffix, key, isFuture) {
        ...
        switch (key) {
            ...
            case 'MM': // 9 months / in 9 months / 9 months ago
                if (withoutSuffix || isFuture) {
                    return result + (cs__plural(number) ? 'm?síce' : 'm?síc?');
                } else {
